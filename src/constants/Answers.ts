export enum Answers {
  ...
  ITALIAN_ANCESTRY_RESIGN_NOT_OK,
  ITALIAN_ANCESTRY_RESIGN_OK,
  ITALIAN_ANCESTRY_ONLY_MEN,
  ITALIAN_ANCESTRY_NOT_ONLY_MEN,
  ITALIAN_ANCESTRY_CHILD_NOT_OK,
  ITALIAN_ANCESTRY_CHILD_OK,
  SPAIN_REFUGEE,
  SPAIN_NOT_REFUGEE,
